...
const initialState = {
  applyJobs: [
    ...
    {
      jobTitle: 'ifsudhifdsfi',
      salaryPackage: 'aassssssss',
      requirement: 'dsadsa',
      experience: 'dsadadddddddddddddddd',
      designation: 'fnghfnhfbfgbfgbfg',
      description: 'qqqqqqqqqqq',
    },
    {
      jobTitle: 'dsadsadsdsaddsa',
      salaryPackage: 'dsadadddsad',
      requirement: 'dsadsaddsdsad',
      experience: 'asdadsdadsad',
      designation: 'fnghfnhfbfgbfgbfg',
      description: 'fsdfdsfsdffsfd',
    },
    {
      jobTitle: 'ffdsfsdfsdfsdfsdffff',
      salaryPackage: 'dsadffffqewfeffffsad',
      requirement: 'fsdfsdfsdsswqqqqqq',
      experience: 'gsdfsdfsdfsdfffff',
      designation: 'fnghfnhfbfgbfgbfg',
      description: 'fsfsfgsdggggggggg',
    },
    {
      jobTitle: 'safsafsaf',
      salaryPackage: 'kjkhhgj',
      requirement: 'jhweaqas',
      experience: 'daddafffggg',
      designation: 'fnghfnhfbfgbfgbfg',
